...
public class StreetMessagingService extends Service {
    private static final String TAG = StreetMessagingService.class.getSimpleName();

    public static final String READ_ACTION =
            "de.uni_frankfurt.cs.ccc.sse.adam.ACTION_MESSAGE_READ";
    public static final String REPLY_ACTION =
            "de.uni_frankfurt.cs.ccc.sse.adam.ACTION_MESSAGE_REPLY";
